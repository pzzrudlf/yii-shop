...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        if ($this->db->driverName === 'mysql') {
            ...
            $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB  COMMENT=\'RBAC规则表\'';
        }
        ...
        if ($this->db->driverName === 'mysql') {
            // http://stackoverflow.com/questions/766809/whats-the-difference-between-utf8-general-ci-and-utf8-unicode-ci
            $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB  COMMENT=\'RBAC权限和角色表\'';
        }
        ...
        if ($this->db->driverName === 'mysql') {
            // http://stackoverflow.com/questions/766809/whats-the-difference-between-utf8-general-ci-and-utf8-unicode-ci
            $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB  COMMENT=\'RBAC管理员表\'';
        }
